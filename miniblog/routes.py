...
from miniblog import app, db, bcrypt, mail
from miniblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
